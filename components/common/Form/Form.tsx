...
export const Form = () => {
  ...
  return (
    <>
      ...
      >
        <h3 className="mb-5 text-center font-raleway text-lg font-semibold uppercase leading-[1.35] md:mb-6 md:text-xl md:leading-[1.35] xl:text-[22px] xl:leading-[1.35] ">
          {form.formTitle}
        </h3>
